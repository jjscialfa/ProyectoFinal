...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://jjscialfa:SL!qmB2NjYeMn_C@jjscialfa.mysql.pythonanywhere-services.com/jjscialfa$proyecto"
...
class Producto(db.Model):  # Producto hereda de db.Model
    ...
    def __init__(self, nombre, precio, stock, categoria, imagen):
        """
...
def create_producto():
    ...
    new_producto=Producto(nombre,precio,stock,categoria,imagen)  # Crea un nuevo objeto Producto con los datos proporcionados
